...
public:
	...
	uint8                                         Pad_1F72[0x6];                                     // 0x0012(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(ActivePlayersRow_C_SetPlayerName, Param_PlayerName) == 0x000000, "Member 'ActivePlayersRow_C_SetPlayerName::Param_PlayerName' has a wrong offset!");
