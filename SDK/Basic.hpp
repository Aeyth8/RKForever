...
namespace Offsets
{
	constexpr int32 GObjects          = 0x049E0740;
	constexpr int32 AppendString      = 0x00F21A40;
	constexpr int32 GNames            = 0x049C8E40;
	constexpr int32 GWorld            = 0x04ACAAF0;
	constexpr int32 ProcessEvent      = 0x010D2610;
