...
// Parameters:
// float                                   CooldownTimeRemaining                                  (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UGameplayAbility::GetCooldownTimeRemainingAndDuration(float* CooldownTimeRemaining, float* CooldownDuration) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GameplayAbility", "GetCooldownTimeRemainingAndDuration");

	Params::GameplayAbility_GetCooldownTimeRemainingAndDuration Parms{};
	...
	if (CooldownTimeRemaining != nullptr)
		*CooldownTimeRemaining = Parms.CooldownTimeRemaining;
