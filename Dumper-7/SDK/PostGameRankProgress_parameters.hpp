...
static_assert(offsetof(PostGameRankProgress_C_HasRewardItems, HasRewardItems_0) == 0x000000, "Member 'PostGameRankProgress_C_HasRewardItems::HasRewardItems_0' has a wrong offset!");
...
{
public:
	bool                                          HasCurrency_0;                                     // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(offsetof(PostGameRankProgress_C_HasCurrency, HasCurrency_0) == 0x000000, "Member 'PostGameRankProgress_C_HasCurrency::HasCurrency_0' has a wrong offset!");
