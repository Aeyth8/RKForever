...
// Parameters:
// struct FDonNavigationDynamicCollisionPayloadData                                                   (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
...
void ADonNavigationManager::AddActorToIgnoreForCollision(class AActor* Actor)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("DonNavigationManager", "AddActorToIgnoreForCollision");

	Params::DonNavigationManager_AddActorToIgnoreForCollision Parms{};
...
// Function DonAINavigation.DonNavigationManager.Debug_FlushDrawnVolumes
// (Final, Native, Public, BlueprintCallable)

void ADonNavigationManager::Debug_FlushDrawnVolumes()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("DonNavigationManager", "Debug_FlushDrawnVolumes");
...
void ADonNavigationManager::RemoveActorToIgnoreForCollision(class AActor* Actor)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("DonNavigationManager", "RemoveActorToIgnoreForCollision");

	Params::DonNavigationManager_RemoveActorToIgnoreForCollision Parms{};
...
// class AActor*                           Actor                                                  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct FVector                          Destination                                            (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                                    ShowDebugData                                          (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                                    ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool ADonNavigationManager::SchedulePathfindingTaskSimple(class AActor* Actor, const struct FVector& Destination, bool ShowDebugData)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("DonNavigationManager", "SchedulePathfindingTaskSimple");

	Params::DonNavigationManager_SchedulePathfindingTaskSimple Parms{};

	Parms.Actor = Actor;
	Parms.Destination = std::move(Destination);
	Parms.ShowDebugData = ShowDebugData;
