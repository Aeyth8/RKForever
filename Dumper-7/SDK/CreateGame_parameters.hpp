...
static_assert(offsetof(CreateGame_C_ChangeBotOptionVisibility, Visibility_0) == 0x000000, "Member 'CreateGame_C_ChangeBotOptionVisibility::Visibility_0' has a wrong offset!");
